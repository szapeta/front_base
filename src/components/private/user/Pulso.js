...
export const Pulso = () => {
        ...
        axios.get("http://44.204.185.36:4000/api").then((res) => {
            ...
            dataCalorias.forEach((itemcaloria) => {
                if (itemcaloria.date == fecha) {
                    ...
                    arrCalorias.push(itemcaloria.heartRate);
    ...
    const data = useMemo(function () {
        return {
            datasets: [
                {
                    label: "Pulso vs Tiempo",
                    data: calorias,
                    tension: 0.3,
                    borderColor: "rgb(68, 170, 14)",
                    pointRadius: 6,
                    pointBackgroundColor: "rgb(94, 226, 23)",
                    backgroundColor: "rgba(60, 113, 32, 0.3)",
                },
            ],
            labels: tiempo,
        };
